...
AFRAME.registerComponent("ik-controller", {
  ...
  update(oldData) {
    ...
    // now setting the middle eye position to the middle of left and right eye positions or at the height of 1.6 if it's missing
  ...
  tick(time, dt) {
    ...
    // removing the left and right controllers from the camera so that they're moving to the front
